...
namespace ProyectoIntegrador.Controllers
{
    public class PerfilesController : Controller
    {
        ...
        public PerfilesController(MainContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,NombreTienda,Dirección")] Perfil perfil)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,NombreTienda,Dirección")] Perfil perfil)
        {
            if (id != perfil.Id)
            {
                return NotFound();
